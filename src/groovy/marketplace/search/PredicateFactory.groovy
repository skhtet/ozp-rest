...
class PredicateFactory implements Serializable {
    ...
    private PredicateFactory() {
        ...
        predicateTemplates = [
                ...
                categoryFilters: new MultiValuePredicate(predicateName: "category", indexFieldName: "categories.id", paramName: "categoryFilters"),
				typeFilters: new MultiValuePredicate(predicateName: "types", indexFieldName: "types.id", paramName: "typeFilters"),
				agencyFilters: new MultiValuePredicate(predicateName: "agency", indexFieldName: "agency.id", paramName: "agencyFilters"),
