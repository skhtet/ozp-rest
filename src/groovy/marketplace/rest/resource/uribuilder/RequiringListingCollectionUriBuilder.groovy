...
class RequiringListingCollectionUriBuilder implements ChildCollectionUriBuilder<Listing, Listing>, ObjectUriBuilder<Listing> {

    private ApplicationRootUriBuilderHolder uriBuilderHolder
    private ObjectUriBuilder<Listing> listingUriBuilder

    protected RequiringListingCollectionUriBuilder(
    ...
    */
    ...
    CollectionUriBuilder<Listing> getCollectionUriBuilder(
        ChildObjectCollection<Listing, Listing> collection) {
    ...
    public static class Factory implements ChildCollectionUriBuilder.Factory<Listing, Listing>, ObjectUriBuilder.Factory<Listing> {
        ...
        RequiringListingCollectionUriBuilder getBuilder(ApplicationRootUriBuilderHolder uriBuilderHolder) {
            new RequiringListingCollectionUriBuilder(uriBuilderHolder, listingUriBuilderFactory.getBuilder(uriBuilderHolder))
        }
    }
}
